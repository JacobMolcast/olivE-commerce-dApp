...
interface IERC721 is IERC165 {
     ...
     */
    function tokenBalanceOf(address owner) external view returns (uint256 balance);
...
abstract contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
     ...
     */
    function tokenBalanceOf(address owner) public view virtual override returns (uint256) {
    ...
    function safeTransferFrom (
        ...
        require(_isApprovedOrOwner(_msgSender(), tokenId), "ERC721: caller is not token owner nor approved");
        _safeTransfer(from, to, tokenId, buyer);
    }
    ...
    function _safeTransfer(
        ...
        _transfer(from, to, tokenId, buyer);
        require(_checkOnERC721Received(from, to, tokenId, buyer), "ERC721: transfer to non ERC721Receiver implementer");
    }
...
////////////////////////////
    ...
    function _safeMint(
        ...
        _mint(to, tokenId, buyer);
        require(
            _checkOnERC721Received(address(0), to, tokenId, buyer),
     ...
     * Emits a {Transfer} event.
     */
    function _mint(address to, uint256 tokenId, address buyer) internal {
...
///////////////////
    ...
    function _transfer(
        ...
        require(from != buyer, "This token is your MEMBER SOUL you can't transfer it");
    ...
    function _checkOnERC721Received(
        ...
        if (to.isContract()) {
            try IERC721Receiver(to).onERC721Received(_msgSender(), from, tokenId, buyer) returns (bytes4 retval) {
...
contract SupplyChainToken is ERC721, Ownable {
    ...
    function mint(address payable tokensWallet) virtual public payable{
        ...
        _safeMint(tokensWallet, tokenId, tx.origin);
...
contract SBT is SupplyChainToken{
    ...
    function mint(address payable tokenWallet) public payable override {
        ...
        memberPurchases[tx.origin] ++; //increment by one and tx.origin will take the address of the buyer because if msg.sender is in here the contract address will be the one stated
...
contract BottleBuy is SBT{
    ...
    uint256 public bottlePrice = 1 ether;
   ...
   //By default the variable isBuyEnabled is false. This way the contractOwner can change it.
    ...
    function ChangeharvestStatus() public onlyContractOwner {
